...
input_list = [0, 1, 70, 63, 134, 5, 10, 10, 60, 120, 4, 4, 1, 1, 1, 1, 1, 10, 1, 1, 1], [0, 1, 70, 63, 134, 5, 10, 10, 60, 120, 4, 4, 1, 1, 1, 1, 1, 10, 1, 1, 1]

#result = mortality_gam.sample(input_list, 0.436, quantity='y')

result = gam.quick_sample(
    gam= mortality_gam,
    sample_at_X= input_list,
    random_seed= 5,
    quantity= 'mu',
    n_draws=100
)
